...
namespace DZ2_Logic
{
    public class Weather
    {
        ...
        {
            return $"T={GetTemperature().ToString("G",CultureInfo.InvariantCulture)}°C, w={GetWindSpeed().ToString("G", CultureInfo.InvariantCulture)}km/h, h={GetHumidity().ToString("G", CultureInfo.InvariantCulture)}%";
        }
